...
ResourceMap.prototype = {
	...
	getResource : function(resourceName, resourceIndexField, collection) {
		...
		repo.once("data", function(nodeData) {
			console.log("GET RESOURCE DATA RECIEVED======, ", nodeData);
		...
		var resKeys = this._resolve(umap); // make this return a string		
		//['d3fb7a2bbd060b94f086e5821e7df22dff9625fa', 'projects', 'adrian-com', 'details']
		//d3fb7a2bbd060b94f086e5821e7df22dff9625fa 3 'projects' 'adrian-com' 'details'
	...
	/* 
		...
		@route {String, Object}
	*/
	_resolve : function(route) {
		//TODO: convert projects/adrian-com/h/details into something that repo.getNode can use (front-End)
		...
		//Todo: Connect the repos api to REDIS and retrieve record.... 
		//repo.getNode()
		//'a7fd5e73545092e74ada4ca019d230cae4a5ec8c'
		//d3fb7a2bbd060b94f086e5821e7df22dff9625fa 3 'projects' 'adrian-com' 'details'
		//in the get node.. the hashtag should match the config name and get the SHA value for the script
		// should return args len and keys to be used
		// this shoud also extract the SHA config values for the LUA script
		//objectId,  argLen , param1, param2,
		return ['244f732757c3dde6f94d7b06cac65f0d5f5b983b', 'projects', 'adrian-com', 'details'];
	},
