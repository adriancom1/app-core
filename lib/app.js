...
var rootHandler = require('./core/renditions').root;
...
(function(exports) {
  ...
  exports.create = function() {
	...
	// mockup test route
	"stores/<stores>/products/<products>" : function(resource) {
		return resource.render({
			html: function() {
				return "Stores Page = "  + resource.getVars() + ". Worked.";
			},
			json: function() {
				return {stores: 'worked', output: resource.getVars()};
			},
		});
	}
})
  ...
  /* App Main Class */
	...
	App.prototype.route = function() {
		...
		* @rootHandler is a rendition type from the renditions module.
		*/
		arguments[0]["_root"] = App._rootLocation || rootHandler;
	...
	*/
	...
	//Default Root Page Route Override
